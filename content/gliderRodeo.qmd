...
Autonomous gliders also provide environmental measures in the form of conductivity-temperature-depth (CTD) sensors (at a minimum), and may include any number of additional sensors to study the biotic and abiotic environment. Environmental sensors on Unit_1024 included temperature, chlorophyll, and backscatter (see preliminary environmental data visualizations, below). Environmental sensors such as pumped CTDs can add electrical and radiated noise that may interfere with passive acoustic data quality. Additional information on environmental data products for the SWFSC Slocum Gliders is provided [here](https://swfsc.github.io/glider-lab-manual/content/glider-data.html#data-products).

![Environmental data collected during sea trial of Unit_1024 including temperature, chlorophyll, and backscatter including data plotted along geographic map (top), by depth (middle) and a gridded data plotted by profile index and depth (bottom).](images/unit_1024-20250224_oceo.png)
